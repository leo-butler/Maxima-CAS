...
;;; ("$Id: dqmomo.lisp,v 1.10 2009/01/08 18:25:34 rtoy Exp $"
;;;  "$Id: dqmomo.lisp,v 1.10 2009/01/08 18:25:34 rtoy Exp $"
;;;  "$Id: dqmomo.lisp,v 1.10 2009/01/08 18:25:34 rtoy Exp $"
;;;  "$Id: dqmomo.lisp,v 1.10 2009/01/08 18:25:34 rtoy Exp $"
;;;  "$Id: dqmomo.lisp,v 1.10 2009/01/08 18:25:34 rtoy Exp $"
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dqmomo
          ...
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((double-float) (double-float) (array double-float (25))
                        (array double-float (25)) (array double-float (25))
                        (array double-float (25)) (fortran-to-lisp::integer4))
           :return-values '(nil nil nil nil nil nil nil)
           :calls 'nil)))
