...
;;; ("$Id: dqagi.lisp,v 1.10 2009/01/08 18:25:34 rtoy Exp $"
;;;  "$Id: dqagi.lisp,v 1.10 2009/01/08 18:25:34 rtoy Exp $"
;;;  "$Id: dqagi.lisp,v 1.10 2009/01/08 18:25:34 rtoy Exp $"
;;;  "$Id: dqagi.lisp,v 1.10 2009/01/08 18:25:34 rtoy Exp $"
;;;  "$Id: dqagi.lisp,v 1.10 2009/01/08 18:25:34 rtoy Exp $"
...
(defun dqagi
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((lvl 0) (l1 0) (l2 0) (l3 0))
     ...
     label10
      (if (= ier 6) (setf lvl 1))
      (if (/= ier 0) (xermsg "SLATEC" "DQAGI" "ABNORMAL RETURN" ier lvl))
      (go end_label)
     end_label
      (return
       (values nil
  ...
  (setf (gethash 'fortran-to-lisp::dqagi fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil nil nil nil fortran-to-lisp::result
                            ...
                            nil nil)
           :calls '(fortran-to-lisp::xermsg fortran-to-lisp::dqagie))))
