...
;;; ("$Id: dqawf.lisp,v 1.10 2009/01/08 18:25:34 rtoy Exp $"
;;;  "$Id: dqawf.lisp,v 1.10 2009/01/08 18:25:34 rtoy Exp $"
;;;  "$Id: dqawf.lisp,v 1.10 2009/01/08 18:25:34 rtoy Exp $"
;;;  "$Id: dqawf.lisp,v 1.10 2009/01/08 18:25:34 rtoy Exp $"
;;;  "$Id: dqawf.lisp,v 1.10 2009/01/08 18:25:34 rtoy Exp $"
    ...
    (prog ((limit 0) (ll2 0) (lvl 0) (l1 0) (l2 0) (l3 0) (l4 0) (l5 0) (l6 0))
      ...
      (multiple-value-bind
          ...
          (dqawfe f a omega integr epsabs limlst limit maxp1 result abserr
           ...
           (f2cl-lib:array-slice iwork f2cl-lib:integer4 (1) ((1 *))) lst
           ...
           (f2cl-lib:array-slice work double-float (l5) ((1 *)))
           (f2cl-lib:array-slice iwork f2cl-lib:integer4 (l1) ((1 *)))
           (f2cl-lib:array-slice iwork f2cl-lib:integer4 (ll2) ((1 *)))
           (f2cl-lib:array-slice work double-float (l6) ((1 *))))
