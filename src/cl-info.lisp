...
; UNRESOLVED
;  - DUPLICATE ITEMS
;    MAKE KEY = (ITEM NAME . SECTION TITLE)
;    SO THAT ITEMS WITH SAME NAME IN DIFFERENT SECTIONS ARE DISTINCT
;  - NEED TO SORT RETURN LIST
;  - MAKEFILE STUFF
;  - I18N
;  - GATHER SECTION TITLES AT SAME TIME AS INDIVIDUAL ITEMS
;  - MAKE SURE THAT @DEFUN LONGER THAN 1 LINE IS OK
